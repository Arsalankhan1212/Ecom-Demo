...
public abstract class Hilt_ProductRatingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductRatingFragment() {
    super();
  }

  Hilt_ProductRatingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductRatingFragment_GeneratedInjector) this.generatedComponent()).injectProductRatingFragment(UnsafeCasts.<ProductRatingFragment>unsafeCast(this));
    }
  }
